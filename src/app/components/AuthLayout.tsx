...
export default function AuthLayout({ title, children }: AuthLayoutProps) {
  ...
  return (
    <div className="relative">
      <div className="hidden top-4 left-1/2 fixed flex gap-2 bg-yellow-50 p-3 border-2 border-yellow-400 rounded-md w-full max-w-xl font-medium text-yellow-800 text-sm -translate-x-1/2">
        <div>
          <Info />
        </div>
        <p>Our system uses a free WebService hosted on Render. As a result, it may take approximately 5–10 minutes to &quot;wake up&quot; and function properly after being accessed.
          We apologize for the inconvenience, and thank you for your patience.</p>
      </div>
